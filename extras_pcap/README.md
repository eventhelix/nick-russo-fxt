# Extras — VisualEther FXT

VisualEther FXT files for **Extras** (IPv4 Options / Fragments) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `extras_pcap`
