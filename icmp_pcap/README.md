# ICMP — VisualEther FXT

VisualEther FXT files for **ICMP** (Ping / Traceroute / NDP) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `icmp_pcap`
