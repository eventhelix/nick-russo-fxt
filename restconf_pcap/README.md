# RESTCONF — VisualEther FXT

VisualEther FXT files for **RESTCONF** (HTTP REST API) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `restconf_pcap`
