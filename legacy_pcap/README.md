# Legacy — VisualEther FXT

VisualEther FXT files for **Legacy** (IPX / AppleTalk / DECnet) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `legacy_pcap`
