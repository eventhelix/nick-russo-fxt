# Non-IP — VisualEther FXT

VisualEther FXT files for **Non-IP** (ARP / CDP / LLDP / LACP) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `nonip_pcap`
