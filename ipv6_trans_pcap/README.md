# IPv6 Transition — VisualEther FXT

VisualEther FXT files for **IPv6 Transition** (6to4 / 6rd / ISATAP) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `ipv6_trans_pcap`
