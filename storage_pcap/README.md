# Storage — VisualEther FXT

VisualEther FXT files for **Storage** (SMB / NFS / iSCSI) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `storage_pcap`
