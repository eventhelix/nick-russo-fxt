# HTTP — VisualEther FXT

VisualEther FXT files for **HTTP** (HTTP/2 / HTTP/3 / QUIC) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `http_pcap`
