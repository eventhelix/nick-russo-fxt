# Ethernet OAM — VisualEther FXT

VisualEther FXT files for **Ethernet OAM** (CFM / OAM PDU / E-LMI) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `eoam_pcap`
