# IP L2VPN — VisualEther FXT

VisualEther FXT files for **IP L2VPN** (L2TP / VXLAN / OTV) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `ip_l2vpn_pcap`
