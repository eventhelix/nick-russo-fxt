# Network Services — VisualEther FXT

VisualEther FXT files for **Network Services** (DHCP / DNS / SNMP / NTP) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `netsrv_pcap`
