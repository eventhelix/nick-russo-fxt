# WLAN — VisualEther FXT

VisualEther FXT files for **WLAN** (802.11 / CAPWAP / Roaming) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `wlanpcap`
