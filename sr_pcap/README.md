# Segment Routing — VisualEther FXT

VisualEther FXT files for **Segment Routing** (PCEP / BGP-LS / SRv6) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `sr_pcap`
