# NetFlow — VisualEther FXT

VisualEther FXT files for **NetFlow** (v5 / v9 / IPFIX) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `netflow_pcap`
