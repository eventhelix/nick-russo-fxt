# Diagnostics — VisualEther FXT

VisualEther FXT files for **Diagnostics** (ICMP / IP SLA) packet captures.
...
`hosts.txt` was authored against captures from Nick Russo's `diag_pcap`
